...
const useAccordion = (props) => {
  ...
  const [state, send] = react.useMachine(accordion__namespace.machine(initialContext), { context });
  return accordion__namespace.connect(state, send, react.normalizeProps);
};
