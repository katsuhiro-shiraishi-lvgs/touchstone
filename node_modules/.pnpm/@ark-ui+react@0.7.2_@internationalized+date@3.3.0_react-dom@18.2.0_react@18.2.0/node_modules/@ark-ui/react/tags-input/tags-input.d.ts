...
export declare const TagsInput: ForwardRefExoticComponent<{
    ...
    allowEditTag?: boolean | undefined;
    onTagUpdate?: ((details: {
        value: string;
        index: number;
    }) => void) | undefined;
