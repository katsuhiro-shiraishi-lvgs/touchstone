...
function getRootStyle(ctx) {
  ...
  const offsetStyles = ctx.value.reduce((styles, value, index) => {
    ...
    const offset = slider.unstable__dom.getThumbOffset({ ...ctx, value, thumbSize });
...
const styleGetterFns = {
  getRootStyle,
  getControlStyle: slider.unstable__dom.getControlStyle,
  getThumbStyle,
  getRangeStyle: slider.unstable__dom.getRangeStyle,
  getMarkerStyle: slider.unstable__dom.getMarkerStyle,
  getMarkerGroupStyle: slider.unstable__dom.getMarkerGroupStyle
};

exports.getRangeOffsets = getRangeOffsets;
exports.styleGetterFns = styleGetterFns;
