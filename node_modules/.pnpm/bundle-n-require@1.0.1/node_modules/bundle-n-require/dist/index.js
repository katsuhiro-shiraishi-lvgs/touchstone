...
function requireDirect(file) {
  const fileName = import_fs.default.realpathSync(file);
  delete require.cache[file];
  const mod = require(fileName);
  return {
    mod: mod.default ?? mod,
    dependencies: [fileName],
    code: import_fs.default.readFileSync(fileName, "utf-8")
  };
}
...
function loadBundledFile(file, code) {
  ...
  const realFileName = import_fs.default.realpathSync(file);
