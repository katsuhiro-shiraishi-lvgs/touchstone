import type { Calendar, CalendarDate, CalendarDateTime, DateDuration, DateFormatter, DateValue, ZonedDateTime } from "@internationalized/date";
...
type PublicContext = DirectionProperty & CommonProperties & {
     ...
     */
    onFocusChange?: (details: ChangeDetails<{
        focusedValue: DateValue;
        view: DateView;
    }>) => void;
    /**
