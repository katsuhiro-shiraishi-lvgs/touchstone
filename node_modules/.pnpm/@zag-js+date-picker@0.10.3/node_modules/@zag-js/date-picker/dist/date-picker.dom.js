...
const dom = domQuery.createScope({
  ...
  getFocusedCell: (ctx, view = ctx.view) => domQuery.query(dom.getContentEl(ctx), `[data-part=cell-trigger][data-type=${view}][data-focused]:not([data-outside-range])`),
