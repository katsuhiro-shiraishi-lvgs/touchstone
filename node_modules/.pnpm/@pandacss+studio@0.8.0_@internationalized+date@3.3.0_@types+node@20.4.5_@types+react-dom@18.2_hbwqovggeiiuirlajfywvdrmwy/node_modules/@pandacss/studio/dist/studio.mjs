...
function npmRunPath(options = {}) {
  ...
  let cwdPath = path2.resolve(cwdString);
  const result = [];
  ...
  result.push(path2.resolve(cwdString, execPath, ".."));
  return [...result, path_].join(path2.delimiter);
}
...
var handleArguments = (file, args, options = {}) => {
  ...
  if (process4.platform === "win32" && path3.basename(file, ".exe") === "cmd") {
    args.unshift("/q");
  }
